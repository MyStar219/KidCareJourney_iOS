...
static NSString * const kSearchLimit       = @"25";
...
- (NSMutableArray *)filterArray:(NSArray *)nearByRestaurantsJSON{
    ...
    for (NSDictionary *jsonDict in nearByRestaurantsJSON) {
        ...
        float distanceTo = [arrToDistance floatValue] * convertMileToKilometre * 1000.0;
...
*/
- (void)queryBusinessInfoForBusinessId:(NSString *)businessID completionHandler:(void (^)(NSArray *topBusinessJSON, NSError *error))completionHandler {
